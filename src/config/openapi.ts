    ...
    components: {
      ...
      schemas: {
        ...
        MissionPreviewFactsInput: {
          type: "object", required: ["fieldBlockId", "cropBatchIds", "marketQuality", "plannedHarvestKg", "plannedDriedKg", "deadline", "harvestDurationHours", "estimatedHarvestableKg", "rainProtectionAvailable", "availableWorkerCount", "coveredDryingCapacityKg", "notes", "clarification"], additionalProperties: false,
          properties: {
            fieldBlockId: { type: "string", format: "uuid", nullable: true }, cropBatchIds: { type: "array", maxItems: 12, items: { type: "string", format: "uuid" } },
            marketQuality: { type: "string", enum: ["Grade A", "Grade B", "Grade C"], nullable: true }, plannedHarvestKg: { type: "number", exclusiveMinimum: true, minimum: 0, nullable: true }, plannedDriedKg: { type: "number", exclusiveMinimum: true, minimum: 0, nullable: true }, deadline: { oneOf: [{ type: "string", format: "date-time" }, { type: "string", format: "date" }, { type: "null" }] }, harvestDurationHours: { type: "number", exclusiveMinimum: true, minimum: 0, nullable: true, description: "Farmer-confirmed total harvest duration; no productivity rate is inferred." }, estimatedHarvestableKg: { type: "number", exclusiveMinimum: true, minimum: 0, nullable: true }, rainProtectionAvailable: { type: "boolean", nullable: true }, availableWorkerCount: { type: "integer", minimum: 1, nullable: true }, coveredDryingCapacityKg: { type: "number", exclusiveMinimum: true, minimum: 0, nullable: true, deprecated: true }, notes: { type: "string", nullable: true },
        ...
        MissionFactReview: {
          ...
          properties: { key: { type: "string", enum: ["fieldBlockId", "cropBatchIds", "marketQuality", "plannedHarvestKg", "plannedDriedKg", "deadline", "harvestDurationHours", "estimatedHarvestableKg", "rainProtectionAvailable", "availableWorkerCount", "coveredDryingCapacityKg", "notes"] }, status: { type: "string", enum: ["confirmed", "needs_clarification", "missing"] }, reason: { type: "string" }, provenance: { type: "string", enum: ["FARMER_REPORTED", "INFERRED"] }, confidence: { type: "string", enum: ["high", "medium", "low"] } },
        },
