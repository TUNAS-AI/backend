import { ApiError } from "../../shared/api-error"; import { callerFarmId } from "../farm/caller-farm.service"; import { CropBatchRepository } from "./crop-batch.repository"; import type { CropBatchInput } from "./crop-batch.validation";
export class CropBatchService {
  constructor(private readonly repository = new CropBatchRepository()) {}
