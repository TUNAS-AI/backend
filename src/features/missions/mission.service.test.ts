...
import { canAdvanceMissionStage, interpretationUnavailable, isStepTransitionAllowed, logInterpretationFailure, nextMissionStage, planningUnavailable } from "./mission.service";
import { parsePreviewCandidate } from "./mission.validation";
...
test("discards browser-provided mission review and fact blocks", () => {
  const candidate = parsePreviewCandidate({ candidate: {
    ...
    facts: { fieldBlockId: "00000000-0000-4000-8000-000000000002", cropBatchIds: ["00000000-0000-4000-8000-000000000003"], buyerCommitmentId: null, maturity: "ready", buyerQuantityKg: 60, marketQuality: "A", plannedHarvestKg: 80, plannedDriedKg: 70, deadline: "2026-07-23", availableWorkerCount: null, coveredDryingCapacityKg: null, notes: null, clarification: null },
